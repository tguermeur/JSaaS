...
const StructureSettings: React.FC = () => {
  ...
  const handleImportPreviewError = useCallback((message: string) => {
    setSnackbar({ open: true, message, severity: 'error' });
  }, []);

  const matchContext = useMemo(
    () => ({ users, companies, contacts, missionTypes }),
    [users, companies, contacts, missionTypes]
  );
  ...
  const {
    ...
    processRawRows: handleFileParsed,
    resetPreview: resetImportPreview,
    ...
    onError: handleImportPreviewError,
  });
